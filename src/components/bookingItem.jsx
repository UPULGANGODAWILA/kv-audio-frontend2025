...
import { addToCart, removeFromCart } from "../pages/utils/cart";
...
export default function BookingItem({ itemKey, qty, refresh }) {
  ...
  return (
    <div className="flex w-[600px] my-2 items-center gap-4 p-4 bg-primary shadow-md rounded-lg border border-secondary relative">
      {/* Delete Button */}
      <div
        className="absolute right-[-45px] text-red-500 hover:text-white hover:bg-red-500 p-[10px] rounded-full cursor-pointer"
        onClick={() => {
