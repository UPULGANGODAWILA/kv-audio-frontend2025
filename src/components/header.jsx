...
export default function Header() {
  return (
    <header className="w-full  h-[100px] shadow-xl flex justify-center items-center relative bg-accent text-yellow-100">
      ...
      <Link
        to="/booking"
        className="text-[25px] font-bold m-1 absolute right-3"> <FaShoppingCart/></Link>
    </header>
